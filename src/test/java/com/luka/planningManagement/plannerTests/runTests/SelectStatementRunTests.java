...
import com.luka.simpledb.simpleDB.settings.QueryPlannerType;
...
public class SelectStatementRunTests {
    ...
    private static Stream<Arguments> settingsProvider() {
        SimpleDBSettings settingsBetterPlanner = new SimpleDBSettings();
        settingsBetterPlanner.queryPlannerType = QueryPlannerType.BETTER;

        SimpleDBSettings settingsHeuristicPlanner = new SimpleDBSettings();
    ...
    public void simpleNoPredicateNoJoins(SimpleDBSettings settings) throws IOException {
    ...
    @ParameterizedTest(name = "{0}")
    @MethodSource("settingsProvider")
    public void simpleManyFieldsRenamedNoPredicateNoJoins(SimpleDBSettings settings) throws IOException {
        Path tmpDir = TestUtils.setUpTempDirectory();
        var testData = PlanTestUtils.initializeThreeFullTables(tmpDir, settings);
    ...
    @ParameterizedTest(name = "{0}")
    @MethodSource("settingsProvider")
    public void simpleManyFieldsNotRenamedNoPredicateNoJoins(SimpleDBSettings settings) throws IOException {
        Path tmpDir = TestUtils.setUpTempDirectory();
        var testData = PlanTestUtils.initializeThreeFullTables(tmpDir, settings);
    ...
    @ParameterizedTest(name = "{0}")
    @MethodSource("settingsProvider")
    public void complexNoPredicateNoJoins(SimpleDBSettings settings) throws IOException {
        Path tmpDir = TestUtils.setUpTempDirectory();
        var testData = PlanTestUtils.initializeThreeFullTables(tmpDir, settings);
    ...
    @ParameterizedTest(name = "{0}")
    @MethodSource("settingsProvider")
    public void simpleNoPredicateJoins(SimpleDBSettings settings) throws IOException {
        Path tmpDir = TestUtils.setUpTempDirectory();
        var testData = PlanTestUtils.initializeThreeFullTables(tmpDir, settings);
    ...
    @ParameterizedTest(name = "{0}")
    @MethodSource("settingsProvider")
    public void complexNoPredicateJoins(SimpleDBSettings settings) throws IOException {
    ...
    @ParameterizedTest(name = "{0}")
    @MethodSource("settingsProvider")
    public void simplePredicateFiltersAllJoins(SimpleDBSettings settings) throws IOException {
        Path tmpDir = TestUtils.setUpTempDirectory();
        var testData = PlanTestUtils.initializeThreeFullTables(tmpDir, settings);
    ...
    @ParameterizedTest(name = "{0}")
    @MethodSource("settingsProvider")
    public void simplePredicateJoins(SimpleDBSettings settings) throws IOException {
        // do slower tests only with the better query planner
        assumeTrue(settings.queryPlannerType == QueryPlannerType.HEURISTIC,
                "Slow test, skipping better planner");
    ...
    @ParameterizedTest(name = "{0}")
    @MethodSource("settingsProvider")
    public void wildcardNoJoins(SimpleDBSettings settings) throws IOException {
        Path tmpDir = TestUtils.setUpTempDirectory();
        var testData = PlanTestUtils.initializeThreeFullTables(tmpDir, settings);
    ...
    @ParameterizedTest(name = "{0}")
    @MethodSource("settingsProvider")
    public void wildcardJoins(SimpleDBSettings settings) throws IOException {
        Path tmpDir = TestUtils.setUpTempDirectory();
        var testData = PlanTestUtils.initializeThreeFullTables(tmpDir, settings);
    ...
    @ParameterizedTest(name = "{0}")
    @MethodSource("settingsProvider")
    public void complexPredicateJoinsNullProjectAndEqPredicate(SimpleDBSettings settings) throws IOException {
        Path tmpDir = TestUtils.setUpTempDirectory();
        var testData = PlanTestUtils.initializeThreeFullTables(tmpDir, settings);
    ...
    @ParameterizedTest(name = "{0}")
    @MethodSource("settingsProvider")
    public void complexPredicateJoinsNullProjectAndIsPredicate(SimpleDBSettings settings) throws IOException {
        Path tmpDir = TestUtils.setUpTempDirectory();
        var testData = PlanTestUtils.initializeThreeFullTables(tmpDir, settings);
    ...
    @ParameterizedTest(name = "{0}")
    @MethodSource("settingsProvider")
    public void simpleNoPredicateOnJoins(SimpleDBSettings settings) throws IOException {
        Path tmpDir = TestUtils.setUpTempDirectory();
        var testData = PlanTestUtils.initializeThreeFullTables(tmpDir, settings);
    ...
    @ParameterizedTest(name = "{0}")
    @MethodSource("settingsProvider")
    public void simpleNoPredicateUnions(SimpleDBSettings settings) throws IOException {
        Path tmpDir = TestUtils.setUpTempDirectory();
        var testData = PlanTestUtils.initializeThreeFullTables(tmpDir, settings);
    ...
    @ParameterizedTest(name = "{0}")
    @MethodSource("settingsProvider")
    public void complexPredicateJoinsUnions(SimpleDBSettings settings) throws IOException {
        Path tmpDir = TestUtils.setUpTempDirectory();
        var testData = PlanTestUtils.initializeThreeFullTables(tmpDir, settings);
