package com.luka.planningManagement;
...
public class PlanTestUtils {
    ...
    public record PlanTestData(SimpleDB db, Transaction tx, List<Layout> layouts) { }
    ...
    public static PlanTestData initializeThreeEmptyTables(Path tmpDir) {
        return initializeThreeEmptyTables(tmpDir, new SimpleDBSettings());
    }
    ...
    public static PlanTestData initializeThreeEmptyTables(Path tmpDir, SimpleDBSettings settings) {
        ...
        simpleDB.getMetadataManager().createTable("table3", sch3, tx);
        ...
        Layout layout3 = simpleDB.getMetadataManager().getLayout("table3", tx);

        return new PlanTestData(simpleDB, tx, Arrays.asList(layout1, layout2, layout3));
    }

    /// Default settings.
    public static PlanTestData initializeThreeFullTables(Path tmpDir) {
        return initializeThreeFullTables(tmpDir, new SimpleDBSettings());
    }
    ...
    public static PlanTestData initializeThreeFullTables(Path tmpDir, SimpleDBSettings settings) {
